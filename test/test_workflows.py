...
def charge_event_built_file(charge_source_file, runlist_file, tmp_h5_file):
    ...
    h5flow.run(['yamls/module0_flow/workflows/charge/charge_event_building.yaml'],
               tmp_h5_file,
               charge_source_file,
               verbose=2,
               start_position=0,
...
def charge_reco_file(charge_event_built_file, geometry_file, light_geometry_file, larpix_config_file,
    ...
    h5flow.run(['yamls/module0_flow/workflows/charge/charge_event_reconstruction.yaml'],
               tmp_h5_file,
...
def light_event_built_file(pytestconfig, tmp_path_factory, light_source_file, runlist_file,
    ...
    h5flow.run(['yamls/module0_flow/workflows/light/light_event_building_adc64.yaml'],
               tmp_h5_file,
               light_source_file,
               verbose=2)
...
def light_reco_file(light_event_built_file, light_noise_file, light_signal_file,
    ...
    h5flow.run(['yamls/module0_flow/workflows/light/light_event_reconstruction.yaml'],
               tmp_h5_file,
...
def light_reco_wvfm_file(light_event_built_file, light_noise_file, light_signal_file,
                    light_impulse_file, light_geometry_file, tmp_h5_file):
    print('Light event reconstruction...')
    h5flow.run(['yamls/module0_flow/workflows/light/light_event_reconstruction-keep_wvfm.yaml'],
               tmp_h5_file,
               light_event_built_file,
               verbose=2,
               start_position=0,
...
def charge_assoc_file(charge_reco_file, light_reco_file, tmp_h5_file):
    ...
    h5flow.run(['yamls/module0_flow/workflows/charge/charge_light_assoc.yaml'],
               tmp_h5_file,
               charge_reco_file,
               verbose=2)
...
def combined_file(charge_assoc_file, geometry_file, light_geometry_file, tmp_h5_file,
    ...
    h5flow.run(['yamls/module0_flow/workflows/combined/combined_reconstruction.yaml'],
               tmp_h5_file,
               charge_assoc_file,
               verbose=2,
               end_position=64)
...
def broken_track_sim_file(combined_file_no_light, geometry_file, light_geometry_file, tmp_h5_file,
    ...
    h5flow.run(['yamls/module0_flow/workflows/combined/broken_track_sim.yaml'],
               tmp_h5_file,
...
def delayed_signal_analysis_file(stopping_muon_analysis_file, triplet_response_data_256_file,
    ...
    print('Stopping muon analysis...')
    h5flow.run(['yamls/module0_flow/workflows/analysis/delayed_signal.yaml'],
               tmp_h5_file,
...
def light_calib_file(combined_wvfm_file, tmp_h5_file):
    print('Stopping muon analysis...')
    h5flow.run(['yamls/module0_flow/workflows/combined/light_gain_calibration.yaml'],
               tmp_h5_file,
               combined_wvfm_file,
               verbose=2)
