...
OUTPUT_DIR='/global/cfs/cdirs/dune/users/kunzmann/FSD/flow' #!!! change me
...
# run all stages
WORKFLOW1='yamls/fsd_flow/workflows/light/light_event_building_mpd.yaml'
WORKFLOW2='yamls/fsd_flow/workflows/light/light_extract_response.yaml'
#WORKFLOW2='yamls/fsd_flow/workflows/light/light_event_reconstruction.yaml'
