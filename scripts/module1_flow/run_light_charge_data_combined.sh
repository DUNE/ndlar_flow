...
WORKFLOW3='yamls/module1_flow/workflows/charge/charge_event_building_combined.yaml'
...
WORKFLOW6='yamls/module1_flow/workflows/charge/prompt_calibration.yaml'
