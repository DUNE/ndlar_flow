...
from module0_flow.util.functions import remove_close_values
...
#                return 0
            ...
            df_pixel_map = pd.read_pickle('./geometry/working_map_'+self.module+'_' + self.iogroup + '.pkl')
            ...
            num_segments = int(np.floor(hough_o_data[0]['length']/radius))
