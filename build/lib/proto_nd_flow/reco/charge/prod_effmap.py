...
from proto_nd_flow.util.functions import remove_close_values, get_extent_25, plot_eff_maps
    ...
    def run(self, source_name, source_slice, cache):
        ...
        if self.mode == 'fullmap':
            ...
            if self.plot:
                ...
                plot_eff_maps(all_hist, hit_hist, extent, self.module, self.plot_dir)
