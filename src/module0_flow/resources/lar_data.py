# copied from https://github.com/DUNE/ndlar_flow/blob/main/src/module0_flow/resources/lar_data.py for compatibility (vs. version of ndlarflow used in general here)
